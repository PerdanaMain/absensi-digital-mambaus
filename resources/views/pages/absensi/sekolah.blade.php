...
@section('title', 'Absensi Sekolah')

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">Data Absensi Sekolah</h4>
                    ...
                    <form action="{{ route('sekolah.import') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="mb-3">
                                        <a role="button" href="{{ route('sekolah.template') }}"
        ...
        <div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="{{ url('/sekolah/export') }}" method="POST">
                        @csrf
                        <div class="modal-header">
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($absensi as $key => $a)
                        ...
                        <div class="modal fade" id="updateModal{{ $a->absensiId }}" tabindex="-1"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form action="{{ route('sekolah.update', ['id' => $a->absensiId]) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="modal-header">
    ...
    <script>
        ...
        $(document).on("change", "#matpelId", function() {
            ...
            if (matpelId) {
                ...
                $.ajax({
                    type: "GET",
                    url: "/sekolah/api-santri/" + matpelId,
